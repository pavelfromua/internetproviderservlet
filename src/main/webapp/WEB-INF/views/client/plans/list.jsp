...
<tr>
    <th scope="col">#</th>
    <th scope="col">
        <a href="/client/plans?page=${currentPage}&?sf=product&sd=${rsd}">
            <fmt:message key="list.items.plans.product" />
        </a>
    </th>
    <th scope="col">
        <a href="/client/plans?page=${currentPage}&?sf=name&sd=${rsd}">
            <fmt:message key="list.items.plans.name" />
        </a>
    </th>
    <th scope="col">
        <a href="/client/plans?page=${currentPage}&?sf=price&sd=${rsd}">
